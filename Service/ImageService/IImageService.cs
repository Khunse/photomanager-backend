...
{
    Task<List<Image>> GenerateTempUploadLinkAsync(string userEmail, List<string> fileNames);
    Task<List<Image>> GetImagesListAsync(string userEmail);
    Task<bool> DeleteImagesAsync(string userEmail, List<string> imageNames);
    Task<List<Image>> GenerateTempGetLinkAsync(string userEmail, List<string> fileNames);
